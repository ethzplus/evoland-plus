---
title: Getting Started - Ingest Swiss Arealstatistik LULC Data
author: Jan Hartman
date: 2025-10-16
vignette: >
...
#| label: cleanup
#| include: false
# cleaning this folder up at end of script prevents investigation
unlink("arealstatistik-model.evolanddb", recursive = TRUE)
```


This file introduces `evoland-plus`, or `evoland` for short, using the the example of ingesting the [Arealstatistik (AS)](https://www.bfs.admin.ch/bfs/de/home/dienstleistungen/geostat/geodaten-bundesstatistik/boden-nutzung-bedeckung-eignung/arealstatistik-schweiz.html) land use land cover data into a database.
...
You may call it `my_lulc_model.db` or `🪶🤓.😘` or `arealstatistik-model.evolanddb`, though I strongly advise against using non-ascii characters in filenames.
...
Which lets us know how many row were affected, i.e. deleted: _7_. 
For this domain in the middle of Switzerland, then, this represents a small amount of savings.
As the sparsity of the domain grows - e.g. by omission of adjacent administrative areas, or by omission of certain land use classes - the advantage of the tabular representation becomes clearer.
