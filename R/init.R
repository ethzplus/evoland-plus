...
# reports each of them as "no visible binding for global variable"; declaring them here
# keeps that NOTE from burying real findings.
...
utils::globalVariables(c(
  ...
  "lon", "md5sum", "md5sum_actual", "mean_date", "mean_patch_size", "no_found_files",
  "parent_id_run", "patch_elongation", "patch_isometry", "patch_size_variance",
  "period_length_d", "period_length_y", "rate", "rate_annual", "shape", "sources",
  "start_date", "to_download", "value"
))
